...
export function variantFromLegacy(body = {}) {
  return {
    ...
    allocated_freight_cents: body.allocated_freight_cents,
    additional_cost_cents: body.additional_cost_cents,
    total_cost_cents: body.total_cost_cents,
    price_multiplier: body.price_multiplier,
    price_rounding_mode: body.price_rounding_mode,
    suggested_price_cents: body.suggested_price_cents,
    sale_price_cents: body.sale_price_cents,
    price_manually_overridden: body.price_manually_overridden,
