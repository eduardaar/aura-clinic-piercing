...
import agendaOperationsRoutes from "./routes/agendaOperations.js";
import alertsRoutes from "./routes/alerts.js";
import dashboardRoutes from "./routes/dashboard.js";
import erpRoutes from "./routes/erp.js";
import usersRoutes from "./routes/users.js";
import accessProfilesRoutes from "./routes/accessProfiles.js";
import auditRoutes from "./routes/audit.js";
import optionsRoutes from "./routes/options.js";
import professionalsRoutes from "./routes/professionals.js";
import appointmentsRoutes from "./routes/appointments.js";
import serviceExecutionsRoutes from "./routes/serviceExecutions.js";
...
app.use(agendaOperationsRoutes);
app.use(alertsRoutes);
app.use(dashboardRoutes);
app.use(erpRoutes);
app.use(usersRoutes);
app.use(accessProfilesRoutes);
app.use(auditRoutes);
app.use(optionsRoutes);
app.use(professionalsRoutes);
app.use(appointmentsRoutes);
app.use(serviceExecutionsRoutes);
app.use(salesRoutes);
