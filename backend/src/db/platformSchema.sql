...
-- Transporte de e-mail administrado pela plataforma. A migration versionada
-- 0007 é a fonte histórica; esta definição mantém o bootstrap idempotente
-- compatível com bancos novos durante a transição.
