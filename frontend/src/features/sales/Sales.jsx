...
export function SalesWorkspace() {
  ...
  function handleTabChange(nextTab) {
    ...
    const product = safeJewelry[0];
    const firstVariant = asArray(product?.variants).find((variant) => Number(variant.quantity || 0) > 0)
    ...
    setLine({
      ...
      unit_price: firstVariant?.sale_value || product?.sale_value || 0
    });
  }
